...
def test_belief_prompt_slots_only_reorders_other_fact_candidates():
    system = StructuredMemorySystem()
    blog_observation = Observation.from_dict(
        {
            "obs_id": "obs-blog",
            "source_dataset": "synthetic",
            "source_dialogue_id": "dlg-1",
            ...
            "entity": "user",
            "relation": "other_fact",
            "value": "curated a list of top 10 must-watch films for a blog",
            "value_type": "other",
            "time_scope": "current",
            "status_hint": "active",
            "polarity": "positive",
            "confidence": 0.8,
            "evidence_text": "I curated a list of top 10 must-watch films for a blog.",
            "canonical_gloss": "other_fact=curated a list of top 10 must-watch films for a blog",
        }
    )
    storytelling_observation = Observation.from_dict(
        {
            "obs_id": "obs-story",
            "source_dataset": "synthetic",
            "source_dialogue_id": "dlg-1",
            ...
            "entity": "user",
            "relation": "other_fact",
            "value": "film storytelling techniques",
            "value_type": "other",
            "time_scope": "current",
            "status_hint": "active",
            "polarity": "positive",
            "confidence": 0.8,
            "evidence_text": "I had a chance to learn more about film storytelling techniques.",
            "canonical_gloss": "other_fact=film storytelling techniques",
        }
    )
    music_observation = Observation.from_dict(
        {
            "obs_id": "obs-music",
            "source_dataset": "synthetic",
            "source_dialogue_id": "dlg-1",
            ...
            "polarity": "positive",
            "confidence": 0.8,
            "evidence_text": "I enjoy producing music with software.",
            "canonical_gloss": "music_preference=producing music with software",
        }
    )
    blog_slot = system.slot_encoder.encode(blog_observation, timestamp="2026-04-07T05:00:00Z")
    storytelling_slot = system.slot_encoder.encode(storytelling_observation, timestamp="2026-04-07T05:01:00Z")
    music_slot = system.slot_encoder.encode(music_observation, timestamp="2026-04-07T05:02:00Z")

    ordered = StructuredMemorySystem._belief_prompt_slots(
        "What are some new trends in the film industry recently?",
        [music_slot, blog_slot, storytelling_slot],
    )

    assert [slot.canonical_gloss for slot in ordered] == [
        "music_preference=producing music with software",
        "other_fact=film storytelling techniques",
        "other_fact=curated a list of top 10 must-watch films for a blog",
    ]
