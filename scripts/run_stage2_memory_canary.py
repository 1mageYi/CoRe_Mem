...
def _build_memory_system(
    *,
    ...
    latent_retriever_checkpoint_dir: str | None,
    latent_retriever_device: str,
...
def main() -> int:
    ...
    if args.benchmark == "personamem":
        payload = run_personamem_canary(
            ...
            latent_retriever_checkpoint_dir=args.latent_retriever_checkpoint_dir,
            latent_retriever_device=args.latent_retriever_device,
