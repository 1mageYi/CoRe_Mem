...
- Top next action: `TD-042 / WS-028` 仍是当前主线；当前 retained truth 仍停在 `24/32`，而 `2026-04-19` 的 quick-smoke holdout line 已到 soft-blocker handoff。下一步若继续 `v31`，应放弃当前 `8`-sample micro-tune gating，改为更大样本或更宽 scope 的 decoder / answer-selection 重构
