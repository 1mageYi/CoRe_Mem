...
- Top next action: `TD-054 / WS-040 / v6.5` 当前新主线切到 `facetized observation-to-memory redesign`。`v6.4` 已证明 learned proposer 可以提高 candidate recall，但不能把 clause-level observation 稳定转成 benchmark-needed support；下一步要把 memory unit 从 clause-level slot 推进到 facet-structured latent memory，并用 facet-level attribution / write utility 直接打当前 bottleneck。
...
- Verifier compatibility note: `TD-035 / WS-021`、`TD-036 / WS-022`、`TD-037 / WS-023`、`TD-038 / WS-024`、`TD-039 / WS-025`、`TD-040 / WS-026`、`TD-041 / WS-027`、`TD-042 / WS-028`、`TD-043 / WS-029`、`TD-044 / WS-030`、`TD-045 / WS-031`、`TD-046 / WS-032`、`TD-047 / WS-033`、`TD-048 / WS-034`、`TD-049 / WS-035`、`TD-050 / WS-036`、`TD-051 / WS-037` 与 `TD-052 / WS-038` 的历史完成态/blocked/search truth 仍保留在文档与 artifact 中；当前 active 主线为 `TD-053 / WS-039 / v6.4`。
